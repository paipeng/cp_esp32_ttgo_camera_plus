...
void mqtt_callback_pager_message(String sender, String receiver, String message, unsigned char* textPixels, int dataLen) {
  display.updatePagerMessage(sender, receiver, message, textPixels, dataLen);
}
